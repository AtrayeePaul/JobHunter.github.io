...
<head>
	...
	<title>Job Hunters - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> INDIA <br/> Vanasthalipuram, Telangana<br/>School Junction</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:jobhunter@gmail.com">jobhunter@gmail.com</a>
								</li>
								<li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Job Hunters</h5>
											<p>Job hunters is a job portal, online job management system developed by TEAM"22 for their project in february 2022</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Job Hunters Contact</h5>
								
								<p>Address : INDIA, Vanasthalipuram, Telangana</p>
								<p>Email : <a href="mailto:jobhunter@gmail.com">jobhunter@gmail.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Job hunters Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by TEAM"22</a></li>
								</ul>
